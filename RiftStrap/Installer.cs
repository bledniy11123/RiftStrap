        ...
        public static void HandleUpgrade()
        {
            ...
            if (existingVer is not null)
            {
                ...
                if (Utilities.CompareVersions(existingVer, "2.8.0") == VersionComparison.LessThan)
                {
                    ...
                    string oldStartPath = Path.Combine(Paths.WindowsStartMenu, "RiftStrap");
                    ...
                    Registry.CurrentUser.DeleteSubKeyTree("Software\\RiftStrap", false);
...
#pragma warning disable CS0162
                if (OpenReleaseNotes)
                    Utilities.ShellExecute($"https://github.com/{App.ProjectRepository}/wiki/Release-notes-for-RiftStrap-v{currentVer}");
