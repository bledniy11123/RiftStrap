...
namespace RiftStrap.UI.Elements.Bootstrapper
{
    public partial class CustomDialog
    {
        ...
        {
            ["RiftStrapCustomBootstrapper"] = HandleXmlElement_RiftStrapCustomBootstrapper_Fake,
        ...
        private static void AssertThemeVersion(string? versionStr)
        {
            if (string.IsNullOrEmpty(versionStr))
                throw new CustomThemeException("CustomTheme.Errors.VersionNotSet", "RiftStrapCustomBootstrapper");

            if (!uint.TryParse(versionStr, out uint version))
                throw new CustomThemeException("CustomTheme.Errors.VersionNotNumber", "RiftStrapCustomBootstrapper");
            ...
            switch (version)
            {
                case Version:
                    break;
                case 0:
                    throw new CustomThemeException("CustomTheme.Errors.VersionNotSupported", "RiftStrapCustomBootstrapper", version);
                default:
                    throw new CustomThemeException("CustomTheme.Errors.VersionNotRecognised", "RiftStrapCustomBootstrapper", version);
            }
        }
        ...
        private void HandleXmlBase(XElement xml)
        {
            ...
            if (xml.Name != "RiftStrapCustomBootstrapper")
                throw new CustomThemeException("CustomTheme.Errors.InvalidRoot", "RiftStrapCustomBootstrapper");
            ...
            HandleXmlElement_RiftStrapCustomBootstrapper(this, xml);
