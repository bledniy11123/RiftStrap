...
namespace RiftStrap.UI.ViewModels.About
{
    public class SupportersViewModel : NotifyPropertyChangedViewModel
    {
        ...
        public async void LoadSupporterData()
        {
            ...
            try
            {
                SupporterData = await Http.GetJson<SupporterData>("https://raw.githubusercontent.com/riftstrap/config/main/supporters.json");
            }
            catch (Exception ex)
            {
